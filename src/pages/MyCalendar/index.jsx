...
function MyCalendar() {
  ...
  console.log('🌈 ~ MyCalendar ~ authUser:', authUser);
  ...
  return (
    <MainLayout>
      <div className={styles.calendar_wrapper}>
        ...
        >
          <Option value={STATUS_BOOKING.PENDING}>
            <Badge status={'warning'} className={`text-orange-45`} text={'Chưa diễn ra'} />
          </Option>
          <Option value={STATUS_BOOKING.PROCESSING}>
            <Badge status={'processing'} className={`text-orange-45`} text={'Đang diễn ra'} />
          </Option>
          <Option value={STATUS_BOOKING.SUCCESS}>
            <Badge status={'success'} className={`text-orange-45`} text={'Hoàn thành'} />
          </Option>
        </Select>
        <Calendar
      ...
      >
        <Row gutter={20}>
          <Col span={10}>
            <img
              src={selectedClass?.image_featured ? selectedClass?.image_featured : imageDefaultClass}
          ...
          <Col span={14}>
            ...
            {authUser.user_type === 'ADMIN' || authUser.user_type === null ? (
              <div className={`${styles.contentInfoWrap}`}>
                <div className={`${styles.classSelectedInfo}`}>
