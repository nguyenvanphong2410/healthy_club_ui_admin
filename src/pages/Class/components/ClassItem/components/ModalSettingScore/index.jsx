...
function ModalSettingScore() {
  ...
  const getItems = (panelStyle) => [
    {
      key: '1',
      label: <p className='font-semibold'>Danh sách hội viên</p>,
  ...
  return (
    <>
      <Row gutter={20}>
        <Col sm={14} xs={24}>
          <p className={`${styles.title} mb-4`}>Thông tin lớp thể thao</p>
          ...
          <Row gutter={20}>
            ...
            <Col span={14}>
              ...
              <div className={`${styles.contentInfoWrap}`}>
                <div className={`${styles.classSelectedInfo}`}>
                  <span className={`${styles.fieldName}`}>Hội viên: </span>
                  <span className={`${styles.content}`}>
          ...
          {/* Bỏ điểm */}
        <Col sm={10} xs={24}>
          {/* <p className={`${styles.title} mb-4 flex justify-center text-purple-500`}>Xét điểm cho hội viên</p>
          <div className={`input-wrap`}>
            <Select
              allowClear
              placeholder="Chọn hội viên để xét điểm"
