...
function ModalCreateOrUpdateClass() {
  ...
  return (
    <div>
        ...
        <Row gutter={20}>
          <Col sm={12} xs={24}>
            <div className={`input-wrap`}>
              <div className={'label-wrap'}>
                Tên lớp thể thao <span className={'required'}>*</span>
              </div>
              <Input
                ...
                placeholder={'Nhập tên lớp thể thao'}
              />
            ...
            <div className={`input-wrap`}>
              <div className="label-wrap">
                <label className={`label-input`}>Tài liệu lớp thể thao</label>
              </div>
              <input
                id="pdfFile"
                type="file"
              ...
              >
                ...
                {fileName ? (
                  <Tooltip title={'Xóa lớp thể thao'}>
                    <span
          ...
          <Col sm={12} xs={24}>
            <div className={`input-wrap`}>
              <div className={'label-wrap'}>
                Khóa thể thao <span className={'required'}>*</span>
              </div>
              <Select
                className={'main-select w-full'}
                value={infoClass?.course_id || null}
                allowClear
                placeholder="Chọn khóa thể thao"
            ...
            <div className={`input-wrap`}>
              <div className="label-wrap">
                <label className={`label-input`}>
                  Số lượng hội viên tối đa <span className="italic text-gray-65">(người)</span>
                </label>
              </div>
              <InputNumber
      ...
      <div className={`input-wrap`}>
        <div className={'label-wrap'}>
          Huấn luyện viên <span className={'required'}>*</span>
        </div>
        <Select
          className={'main-select w-full'}
      ...
      <div className={`input-wrap`}>
        <div className="label-wrap">
          <label className={`label-input`}>Hội viên</label>
        </div>
        <Select
          className={'main-select w-full'}
      ...
      <div className={'input-wrap'}>
        ...
        <TextArea
          ...
          placeholder={'Nhập mô tả lớp thể thao'}
        />
