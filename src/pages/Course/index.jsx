      ...
      <section className={styles.listWrap}>
        <div className={styles.headlistWrap}>
          <Input
            ...
            placeholder={'Tìm kiếm khóa thể thao theo mã hoặc tên'}
                ...
                <Card
                  ...
                  title={
                    <div className={`h-[46px] grid items-center`}>
                      <div
                        className="cursor-pointer hover:text-[#cbcbcc] text-[#ffffff]"
                      ...
                      {item.type === PACKAGE_TYPE['NORMALLY'] ? (
                        <div className="text-[13px] font-normal block">
                          <del className="text-[#bb2a2a] italic font-bold">{formatMoney(item.original_price)}</del> |{' '}
                  ...
                  <Row gutter={20}>
                    ...
                    <div className={`${styles.contentInfoWrap}`}>
                        <div className={`${styles.itemInfo}`}>
                          ...
                          <span className='text-blue-45 font-semibold'>{item.code}</span>
                          </span>
                        </div>
                      </div>
                      <div className={`${styles.contentInfoWrap}`}>
                      ...
                      <div className={`${styles.contentInfoWrap}`}>
                        <div className={`${styles.itemInfo}`}>
                          <span className={`${styles.fieldName}`}>Đang tham gia: </span>
                          <span className={`${styles.content}`}>{item.student_of_course.length} hội viên</span>
                        </div>
                      </div>
        ...
        <ModalDefault
          ...
          title={
            <>
              Danh sách lớp thể thao của khóa thể thao <span className="text-color-main">{infoCourses?.name}</span>
            </>
          }
          width={1200}
        >
        ...
        <ModalDeleteDefault
          content={
            <span>
              Bạn có chắc chắn muốn xóa khóa thể thao <strong>{infoCourses?.name}</strong> không?
            </span>
          }
          contentBtn={'Xóa khóa thể thao'}
