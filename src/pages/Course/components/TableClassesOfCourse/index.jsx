    ...
    <>
      <div className={'tableWrap h-[calc(100vh-380px)]'}>
        ...
        <ModalDefault
          ...
          title={<>Danh sách hội viên của lớp <span className='text-color-blue'>{dataInfoClassSelected}</span> thuộc khóa thể thao <span className='text-color-main'>{infoCourses?.name}</span></>}
          width={1400}
        >
